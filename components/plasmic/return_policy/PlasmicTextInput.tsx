...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: uqzitSMnAOoM/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg__f7Nr0)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__sLcRo)}
              role={"img"}
            />
          ),
