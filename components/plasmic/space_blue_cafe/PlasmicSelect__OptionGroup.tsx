...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: _cP2EPe7ItIS/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: RTute5m0XUXi/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__wcW8A)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__oa4Cp)}
              />
            </React.Fragment>
          ),
          value: args.children
